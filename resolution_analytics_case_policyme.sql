...
-- MAGIC %md
-- MAGIC #### 1. Creating a dashboard or analysis using Excel:
-- MAGIC
...
-- MAGIC %md
-- MAGIC #### Approach to diving deep drop-off (I won't following all these step)
-- MAGIC
...
-- MAGIC %md
-- MAGIC
-- MAGIC I'm following the Step 1, some segmentation to look a little:
-- MAGIC
-- MAGIC * Age
-- MAGIC * Gender
-- MAGIC * Product Type
